...
public class HtmlUnitExample {
    public static void main(String[] args)  throws Exception{
        ...
        System.out.println("page tite: " + page.getTitleText());
        System.out.println("Page XML: " + page.asXml().substring(0, 50));
        System.out.println("Pafe txt: " + page.asText().substring(0, 50));
        ...
        HtmlTextInput iput = (HtmlTextInput) page.getElementById("query");
        iput.setValueAttribute("htmlunit");
